...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Savings> _savings = [
    Savings(
      value: 1300,
      template: 'With a dollar for a gram of CO2 saved, you could buy<>Aston Martin DB5s',
    ),
    Savings(
      value: 25,
    ...
    Savings(
      value: 0.01,
      template: 'CO2 emissions equivalent to the volume of<>Footballs eliminated',
    ),
  ];
                          ...
                          children: [
                            _showQuotes
                                ? SizedBox(
                                    ...
                                    child: ListView(
                                      ...
                                      padding: const EdgeInsets.only(bottom: 40.0, left: 30.0),
                                      children: [
                                        Container(
                                          width: 275.0,
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Consumer<UserDetailsModel>(builder: (context, userDetails, child) {
                                    return Text(
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                // color: ThemeColors.darkGreen,
                                border: Border.all(color: ThemeColors.darkGreen, width: 9.0),
                                borderRadius: const BorderRadius.all(Radius.circular(75.0)),
                              ),
                              width: 150.0,
                              height: 150.0,
                              child: Center(
                                child: Consumer<UserDetailsModel>(builder: (context, userDetails, child) {
                                  double totalSavings = userDetails.calculateTotalCO2Saved();
                                  String unit = totalSavings < 1000 ? 'g' : (totalSavings < 100000 ? 'kg' : 'to');
                                  if (unit == 'kg') {
                                    totalSavings /= 1000;
                                  } else if (unit == 'to') {
                              ...
                              child: Pressable(
                                onPressed: () {
                                  setState(() {
                                    ...
                                    _factTimer = Timer.periodic(const Duration(milliseconds: 3500), (_) {
                                      setState(() {
                                        if (++_currentSavingType == _savings.length) {
                                ...
                                child: Consumer<UserDetailsModel>(builder: (context, userDetailsModel, child) {
                                  double totalSaved = userDetailsModel.calculateTotalCO2Saved() / 1000;

                                  double value = totalSaved / _savings[_currentSavingType].value;
                                  ...
                                  return RichText(
                                    ...
                                    text: TextSpan(
                                      text: '${_savings[_currentSavingType].template.split('<>')[0]} ',
                                      style: const TextStyle(
                                        fontSize: 18.0,
                                        fontWeight: FontWeight.w500,
                                        color: Colors.white,
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text: ' ${_savings[_currentSavingType].template.split('<>')[1]}',
                                          style: const TextStyle(
                                            fontSize: 18.0,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.white,
                              ...
                              return SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (_, int index) {
                                    Product product = userDetails.wishlist[index];
                                    ...
                                    return Pressable(
                                      onPressed: () {
                                        showCupertinoModalBottomSheet(
                                          context: context,
                                          builder: (context) => HistoryModalWidget(trip: trip),
                                        );
                                      },
