...
class ScannerScreen extends StatefulWidget {
  ...
  const ScannerScreen({Key? key, this.isEnding = false, this.tripId}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Pressable(
            ...
            child: const Icon(Icons.chevron_left, color: Colors.white, size: 30.0)),
      ...
      body: MobileScanner(
        ...
        onDetect: (capture) async {
          ...
          for (final barcode in barcodes) {
            ...
            _mobileScannerController.stop();
            try {
              String stationIdBase64 = jsonDecode(barcode.rawValue ?? '')['station_id'] ?? '';
              print("==================");
              print(stationIdBase64);
              print("==================");
              ...
              await _networkService.post(
                ...
                widget.isEnding
                    ...
                    : {'user_id': uid, 'type': stationType, 'start_station_id': stationId},
                (result) async {
